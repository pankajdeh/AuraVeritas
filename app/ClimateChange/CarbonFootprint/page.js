        ...
        <div className="max-w-5xl mx-auto bg-white p-8 shadow-lg">
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              {`Carbon Footprint is a measure of Total amount of GHG Emission caused by an activity. We as a Climate Change Consultant will support to Quantify, provide Emission reduction strategy and Carbon offset credits.  `}
            </p>
